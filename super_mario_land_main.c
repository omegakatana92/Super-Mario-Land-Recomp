...
int super_mario_land_main(int argc, char* argv[]) {
    ...
    GBConfig runtime_config = *super_mario_land_default_config();
    ...
    if (differential_mode) {
        ...
        gb_context_set_save_id(generated_ctx, "super_mario_land");
        gb_context_set_save_id(interpreted_ctx, "super_mario_land");
        if (serial_stdout) {
            generated_ctx->callbacks.on_serial_byte = gbrt_serial_stdout;
        }
        super_mario_land_init(generated_ctx, rom_data, rom_size);
        super_mario_land_init(interpreted_ctx, rom_data, rom_size);
        if (data_mod_file) {
    ...
    gb_context_set_save_id(ctx, "super_mario_land");
    ...
    super_mario_land_init(ctx, rom_data, rom_size);
    if (data_mod_file) {
    ...
    const GBPortMetadata port_metadata = {
        ...
        .game_id = "super_mario_land",
        .game_title = "super_mario_land",
        .rom_sha256 = "49fbd2f61f953d5ef28cab73e357e524c3009ad19fcf30f6a9ee0ae273be41dc",
        .rom_size = 65536u,
    };
...
int main(int argc, char* argv[]) {
    return super_mario_land_main(argc, argv);
}
